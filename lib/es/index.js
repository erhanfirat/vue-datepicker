...
import { fillTo, parseDate, compareDates, parseTime, getMonthByStep, getMonthLen, gntYear, gntMonth, gntCalendar, getDateByStep, getHour, getSecond } from '@livelybone/date-generator';
...
var getMinuteNumbers = function getMinuteNumbers(_ref) {
  var min = _ref.min,
      max = _ref.max,
      step = _ref.step;
  var result = [];
