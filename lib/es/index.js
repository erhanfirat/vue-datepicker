...
var __vue_render__$1 = function __vue_render__() {
  ...
  }, [_vm._v(_vm._s(_vm.currDateObj.date))])] : _vm._e()], 2)]), _vm._v(" "), _c('date', {
    directives: [{
      name: "show",
      rawName: "v-show",
...
var script$7 = {
  ...
  computed: {
    ...
    hours: function hours() {
      return this.convert12hFormat(getHour({
  ...
  methods: {
    ...
    convert12hFormat: function convert12hFormat(hours, hour12format) {
      if (hour12format) {
...
var __vue_render__$7 = function __vue_render__() {
  ...
  return _c('div', {
    ...
    return _c('scrollbar', {
      ...
      }, [item.meridiem ? [_vm._v("\n          " + _vm._s(item.value) + "\n          " + _vm._s(item.meridiem) + "\n        ")] : [_vm._v("\n          " + _vm._s(item.value) + "\n        ")]], 2) : _vm._e()];
    })], 2);
  })], 2);
};
